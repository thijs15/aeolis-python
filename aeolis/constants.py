...
MODEL_STATE = dict(
    ('ny', 'nx') = (
        ...
        'u',                                # [m/s] Wind velocity
        'us',                               # [m/s] Component of wind velocity in x-direction
        'un',                               # [m/s] Component of wind velocity in y-direction
        ...
        'phi',                              # [rad] Wind direction
        'zb',                               # [m] Bed level above reference
        'zs',                               # [m] Water level above reference
        'Hs',                               # [m] Wave height
    ),
    ('ny','nx','nfractions') = (
        'ceq',                              # [kg/m^2] Equilibrium sediment concentration integrated over saltation height
        'c',                                # [kg/m^2] Instantaneous sediment concentration integrated over saltation height
        ...
        'entrained',                        # [kg/m^2] Sediment entrainment
        ...
        'th',                               # [m/s] Shear velocity threshold
    ),
    ('ny','nx','nlayers') = (
...
DEFAULT_CONFIG = dict(
    ...
    output_vars       = ['zb', 'zs',
                         ...
                         'u', 'th',
                         'mass',
                         'entrained'],      # Names of spatial grids to be included in output
